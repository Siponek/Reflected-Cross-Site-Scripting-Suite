...
Feature: redirect.php Redirect link with target
    As a user
    I want to see a welcome message with my CSS class
    When I provide my class in the query parameter

    Background:
        Given I am a user accessing the "redirect.php" page with JS disabled
    ...
    Scenario: Attempt to pass XSS NON-INTERACTIVE payload in query parameter
        ...
        Given I am a user accessing the "redirect.php" page
